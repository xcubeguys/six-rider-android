...
/**
 * Created by test on 12/20/16.
 */
public class YourTrips {

    public String driverName,driverImage,carImage,carType,tripDate,tripAmount,pickupLocation,dropLocation,tripID,
            paymentType,UserName,UserImage,UserType,dailycash,endtime,admincommission,companyname,companyfee;
    ...
    public void setPickupLocation(String pickupLocatiop) {
        this.pickupLocation=pickupLocatiop;
    }

...
public class CustomRatingBar extends RatingBar {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Default CustomRatingBar changes color when pressed. This replicates the effect.
        ...
        for (int i = 0; i < getNumStars(); ++i) {
            //Default CustomRatingBar only shows fractions in the interior, not the outline.

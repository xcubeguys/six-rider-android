...
public class MapRipple {
    ...
    private volatile double distance = 600;                       //distance to which ripple should be shown in metres
    private int numberOfRipples = 1;                      //number of ripples to show, max = 4
    private int fillColor = Color.BLACK;           //fillcolor of circle
    private int strokeColor = Color.parseColor("#6F511F");               //border color of circle
    private int strokewidth = 1;                          //border width of circle
    private long durationBetweenTwoRipples = 25000;      //in microseconds.

...
public class SoSActivity extends AppCompatActivity implements CountryCodePicker.OnCountryChangeListener{
    ...
    void sendsms(){
        ...
        System.out.println("new1 ="+contact_no1);
        System.out.println("new2 ="+contact_no2);
        ...
        if (mobileNumbers != null) {
            ...
            System.out.println("in the send loop==>"+mobileNumbers.size());
                ...
                for (int i=0;i<response.length();i++){
                    try {
                        ...
                        if(status.equals("Success")){
                            ...
                            System.out.println("new1 ="+contact_no1);
                            System.out.println("new2 ="+contact_no2);
                            System.out.println("contact_no1_country ="+contact_no1_country);
                            System.out.println("contact_no1_country2 ="+contact_no2_country);
                           ...
                           /* contact_no1_p =  contact_no1.substring(contact_no1.indexOf("no") + 4 , contact_no1.length());
                            ...
                            System.out.println("contact_no1_p ="+contact_no1_p);
                            System.out.println("contact_no1_p ="+contact_no2_p);*/

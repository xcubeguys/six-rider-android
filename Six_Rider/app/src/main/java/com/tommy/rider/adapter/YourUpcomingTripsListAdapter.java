...
import com.tommy.rider.YourUpcomingTripsActivity;

import java.util.ArrayList;
import java.util.List;

public class YourUpcomingTripsListAdapter extends RecyclerView.Adapter {
    private List<YourTrips> tripsListItems;
    YourUpcomingTripsActivity activity;
    ...
    public YourUpcomingTripsListAdapter(YourUpcomingTripsActivity activity, ArrayList<YourTrips> tripsListItems, RecyclerView recyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == VIEW_ITEM){
            View convertView = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.activity_your_upcoming_trips_list, parent, false);
...
//            driverName.setText(trips.getDriverName());
                ((MyViewHolder) holder).tripAmount.setText("$ "+trips.getTripAmount());

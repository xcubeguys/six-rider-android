...
//        Log.d(TAG, "Initialization of CCP");
        ...
        textView_selectedCountry = (TextView) holderView.findViewById(com.tommy.rider.R.id.textView_selectedCountry);
        relative_holder = (RelativeLayout) holderView.findViewById(com.tommy.rider.R.id.relative_countryCodeHolder);
        imageViewArrow = (ImageView) holderView.findViewById(com.tommy.rider.R.id.imageView_arrow);
        codePicker = this;
...
//        Log.d(TAG, "Applying custom property");
        ...
        try {
            ...
            hideNameCode = a.getBoolean(com.tommy.rider.R.styleable.CountryCodePicker_hideNameCode, false);

            //autopop keyboard
            setKeyboardAutoPopOnSearch(a.getBoolean(com.tommy.rider.R.styleable.CountryCodePicker_keyboardAutoPopOnSearch, true));

            //if custom language is specified, then set it as custom
            int attrLanguage = LANGUAGE_ENGLISH;
            if (a.hasValue(com.tommy.rider.R.styleable.CountryCodePicker_ccpLanguage)) {
                attrLanguage = a.getInt(com.tommy.rider.R.styleable.CountryCodePicker_ccpLanguage, 1);
            }
            customLanguage = getLanguageEnum(attrLanguage);

            //custom master list
            customMasterCountries = a.getString(com.tommy.rider.R.styleable.CountryCodePicker_customMasterCountries);
            refreshCustomMasterList();

            //preference
            countryPreference = a.getString(com.tommy.rider.R.styleable.CountryCodePicker_countryPreference);
            refreshPreferredCountries();

            //default country
            defaultCountryNameCode = a.getString(com.tommy.rider.R.styleable.CountryCodePicker_defaultNameCode);
            ...
            if (!setUsingNameCode) {
                int defaultCountryCode = a.getInteger(com.tommy.rider.R.styleable.CountryCodePicker_defaultCode, -1);
            ...
            int contentColor;
            if (isInEditMode()) {
                contentColor = a.getColor(com.tommy.rider.R.styleable.CountryCodePicker_contentColor, 0);
            } else {
      ...
      //      }
            ...
            //text size
            int textSize = a.getDimensionPixelSize(com.tommy.rider.R.styleable.CountryCodePicker_textSize, 0);
            if (textSize > 0) {
            ...
            int arrowSize = a.getDimensionPixelSize(com.tommy.rider.R.styleable.CountryCodePicker_arrowSize, 0);
            if (arrowSize > 0) {
